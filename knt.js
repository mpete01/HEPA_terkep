...
const selectedOptionDiv = document.getElementById("map-title");

// Set the innerHTML of the div initially to the selected option
selectedOptionDiv.innerHTML = selectElement.value;

// Update the div's innerHTML whenever the selection changes
selectElement.addEventListener('change', function() {
  selectedOptionDiv.innerHTML = this.value;
